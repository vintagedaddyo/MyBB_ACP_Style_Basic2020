...
/**
 *
 * MyBB: Basic-Light - Admin CP
 *
 * Filename: style.php
 *
 * Style Author: Justin S. & Vintagedaddyo
 *
 * J Site: http://community.mybb.com/user-1830.html
...
class Page extends DefaultPage
{
	...
	function output_header($title="")
	{
        ...
        echo "  <link href=\"styles/".$this->style."/inc/css/asap.css?family=Asap:400,600,600i|Open+Sans:400,700%26display=swap\" rel=\"stylesheet\">";        		
...
//]]>
		...
		echo "	<div id=\"logo\"><h1><span class=\"visible\">{$lang->mybb_admin_cp}</span></h1></div>\n";
